# create_bp_wood_pile.py
# Run from Unreal Editor: Tools -> Execute Python Script or via MCP execute_python_script.
# Creates BP_WoodPile (Blueprint child of AHomeWorldResourcePile) in /Game/HomeWorld/Building/.
# Sets ResourceType=Wood and AmountPerHarvest=10 on the CDO. Idempotent: reuses existing Blueprint if found.
# Add Smart Object "HarvestWood" and mesh in Editor if desired; see docs/tasks/AGENTIC_BUILDING.md Step 2.3.
...
def _log(msg):
    unreal.log("WoodPile: " + str(msg))
    print("WoodPile: " + str(msg))
...
def main():
    ...
    _log("Done. Add Smart Object HarvestWood and mesh in Editor if desired (see AGENTIC_BUILDING.md Step 2.3).")
