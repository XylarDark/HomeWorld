...
- [docs/DEMO_MAP.md](../../docs/Maps/DEMO_MAP.md) — create map, config, script flow
- [docs/PCG_QUICK_SETUP.md](../../docs/PCG/PCG_QUICK_SETUP.md) — Option B (script + 3 steps), volume sizing
