...
See docs/AGENT_COMPANY.md (roles and accountability) and docs/AUTOMATION_REFINEMENT.md (how run history is used). When run history or the Guardian report mentions an automation gap (Level Streaming, State Tree, PCG), the Refiner suggests a follow-up task to implement a solution or add GUI automation; see docs/AUTOMATION_GAPS.md and .cursor/skills/automation-gap-solutions/SKILL.md.
