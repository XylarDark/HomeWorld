...
1. **Run the build (Editor–build protocol is automatic)**
   ...
   - Safe-Build closes the Editor if running, runs the build, and retries once if the failure was Editor-related (Live Coding / Exit code 6). No manual close required. See [docs/Editor/EDITOR_BUILD_PROTOCOL.md](../docs/Editor/EDITOR_BUILD_PROTOCOL.md).
