...
**Desktop ImageGrab / GUI capture includes Message Log / chrome (2026-09-22, PA-E):** Full-desktop grabs captured **Message Log**, Map Check, or agent chat overlays — not a clean viewport. **Workaround:** Lead **manual viewport capture** for Shot 1/2; close Map Check / Message Log before any host GUI grab.
