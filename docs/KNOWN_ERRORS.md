...
**PA-E MRQ framing ≠ Arrange (post-#172 DESKTOP, 2026-09-22):** Ray hit / stale **CAM_*** possessable Transform / shot2 **Z void** (Garden centroid) can PASS Arrange yet fail stills — **Fix:** doc **CAM_Hero** + cabin-only centroid + **`_clamp_camera_z_above_dress`**; **`PA_E_MRQ_{shot}`** + **add_possessable_mrq_cam**; center-crop assert = visual PASS.
