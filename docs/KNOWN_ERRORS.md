...
**PA-E MRQ PASS recipe (DESKTOP 2026-09-22):** Stale **CAM_*** Sequencer Transform → scrap frame; extent pose → Z void / |Y|>3000 — **Fix:** **`PA_E_MRQ_{shot}`** + **add_possessable_mrq_cam**; **hard_doc_hero** UU (−900,−400,580) / **hard_cabin_close** cabin+(250,−550,280); **`reset_mrq_session_guards()`** before re-prove; **`_clamp_camera_pose_loc`**; center-crop = visual PASS.
