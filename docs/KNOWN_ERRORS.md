...
**PA-E luminance PASS ≠ framing PASS (DESKTOP 2026-09-22):** Hard doc UU / tight offsets can pass mean luma yet crush beige mesh — use **`wide_hero_anchor`** / **`wide_cabin_anchor`** stand-offs + **`PA_E_MRQ_{shot}`** + **`reset_mrq_session_guards()`** + clamp; Lead eyeball + center-crop = visual PASS.
