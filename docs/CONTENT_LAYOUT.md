...
| `/Game/HomeWorld/Harvestables/` | Static meshes for harvestables (trees, rocks, flowers). Assigned to BP_HarvestableTree etc.; filled by batch import from `AssetCreation/Exports/Harvestables/`. See [AssetCreation/README.md](../AssetCreation/README.md). **External sources and licenses:** [Assets/EXTERNAL_ASSET_MANIFEST.md](Assets/EXTERNAL_ASSET_MANIFEST.md), `AssetCreation/Exports/ATTRIBUTION.md`. |
...
| `/Game/HomeWorld/UI/` | Main menu and character UI: **WBP_MainMenu** (parent HomeWorldMainMenuWidget), **WBP_CharacterCreate** / **WBP_CharacterCustomize**. Create folder via ensure_ui_folders.py. See [VisionBoard/Character/CHARACTER_GENERATION_AND_CUSTOMIZATION.md](../VisionBoard/Character/CHARACTER_GENERATION_AND_CUSTOMIZATION.md). |
