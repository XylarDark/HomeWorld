...
**Goal:** Polish the explore → fight → build loop so it is ready for Day 5 playtest sign-off; optionally run Milady folder and pastel material scripts for content prep. No new systems; solidify existing behavior. See [30_DAY_SCHEDULE.md](../workflow/30_DAY_SCHEDULE.md) Day 4 and [VISION.md](../workflow/VISION.md).
...
- Check off Day 4 in [30_DAY_SCHEDULE.md](../workflow/30_DAY_SCHEDULE.md).
- Update [DAILY_STATE.md](../workflow/DAILY_STATE.md): Yesterday = Day 4 work; Today = Day 5 (playtest sign-off); Tomorrow = Day 6 (Homestead Phase 1); Current day = 5.
...
- [VISION.md](../workflow/VISION.md) — Theme, Week 1 goal, success criteria.
