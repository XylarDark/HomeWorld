...
**See also:** [PLANETOID_DESIGN.md](../PLANETOID_DESIGN.md) (proc-gen, sin themes), [NIGHT_ENCOUNTER.md](NIGHT_ENCOUNTER.md) (waves at home, packs on planetoid, key-point bosses), [VISION.md](../workflow/VISION.md) (campaign, day/night, conversion not kill).
