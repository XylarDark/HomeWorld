...
**Purpose:** Design for how the player restores what was lost in the astral and gains buffs for the next night. Aligned with [VISION.md](../workflow/VISION.md) (Day as restoration) and [ASTRAL_DEATH_AND_DAY_SAFETY.md](ASTRAL_DEATH_AND_DAY_SAFETY.md).
