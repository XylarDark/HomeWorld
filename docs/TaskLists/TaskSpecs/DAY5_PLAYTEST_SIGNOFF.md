...
**Goal:** Run the Week 1 playtest (four beats: crash → scout → boss → claim home); sign off Act 1 or record remaining items for buffer days. This is the **prototype gate** — do not start Day 6 (DemoMap layout) until this is done. See [30_DAY_SCHEDULE.md](../30_DAY_SCHEDULE.md) Day 5 and [VISION.md](../../../VisionBoard/Core/VISION.md).
...
If any beat fails, fix or log in [KNOWN_ERRORS.md](../KNOWN_ERRORS.md) / [SESSION_LOG.md](../SESSION_LOG.md) and set T1 to **blocked** in [CURRENT_TASK_LIST.md](../../../VisionBoard/CURRENT_TASK_LIST.md) until resolved.
...
- Mark Day 5 items `[x]` in [30_DAY_SCHEDULE.md](../30_DAY_SCHEDULE.md).
- Update [DAILY_STATE.md](../../../VisionBoard/DAILY_STATE.md): **Yesterday** = Day 5 playtest + sign-off; **Today** = Day 6 (Homestead Phase 1); **Tomorrow** = Day 7; **Current day** = 6.
...
**Purpose:** [CURRENT_TASK_LIST.md](../../../VisionBoard/CURRENT_TASK_LIST.md) T1 requires verifying the four beats (crash, scout, boss, claim home) on DemoMap in PIE. This section records that verification.
...
- [VISION.md](../../../VisionBoard/Core/VISION.md) — Week 1 playtest goal, prototype gate.
- [DAY3_PLACEMENT_AND_PLAYTEST.md](DAY3_PLACEMENT_AND_PLAYTEST.md) — Pre-playtest and in-PIE checklist.
- [MVP_AND_ROADMAP_STRATEGY.md](../../../VisionBoard/MVP_AND_ROADMAP_STRATEGY.md) — Gate and Day 5 scope.
