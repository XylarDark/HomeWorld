...
**Purpose:** Define how the player earns "love" (or bond) during the day and how that value scales night bonuses. Aligned with [VISION.md](../../../VisionBoard/Core/VISION.md) (goal of the day = build up love → bonuses at night) and [DAY_RESTORATION_LOOP.md](DAY_RESTORATION_LOOP.md).
