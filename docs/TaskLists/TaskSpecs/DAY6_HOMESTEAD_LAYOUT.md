...
**Goal:** Define DemoMap bounds (PCG Volume or level blockout) so Homestead Phase 1 has a clear playable region. This is the first Homestead Phase 1 task. See [30_DAY_SCHEDULE.md](../30_DAY_SCHEDULE.md) Day 6 and [DEMO_MAP.md](../DEMO_MAP.md).
