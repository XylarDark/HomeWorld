...
**See also:** [30_DAY_SCHEDULE.md](../30_DAY_SCHEDULE.md) Day 10, [AGENTIC_BUILDING.md](AGENTIC_BUILDING.md), [FAMILY_AGENTS_MASS_STATETREE.md](FAMILY_AGENTS_MASS_STATETREE.md), [DAY9_HOME_PLACEMENT.md](DAY9_HOME_PLACEMENT.md).
...
- **Single entry point for run sequence and commands:** [CONSOLE_COMMANDS.md](../../CONSOLE_COMMANDS.md) links §3 (run sequence) and the command reference; open CONSOLE_COMMANDS for both [VERTICAL_SLICE_CHECKLIST §3](../../../VisionBoard/VERTICAL_SLICE_CHECKLIST.md#3-pre-demo-checklist-before-recording-or-showing) and **hw.PlaceWall**, **hw.CompleteBuildOrder**, **hw.SimulateBuildOrderActivation**.
