...
**See also:** [VISION.md](../../../VisionBoard/Core/VISION.md) (Day and night: physical and spiritual worlds), [PROTOTYPE_SCOPE.md](../../../VisionBoard/PROTOTYPE_SCOPE.md) § Day/night and astral, [DAY12_ROLE_PROTECTOR.md](DAY12_ROLE_PROTECTOR.md), [NIGHT_ENCOUNTER.md](NIGHT_ENCOUNTER.md).
