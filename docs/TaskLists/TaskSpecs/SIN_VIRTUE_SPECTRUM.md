...
**Purpose:** Design for the moral system per [VISION.md](../../../VisionBoard/Core/VISION.md) § Moral system: Seven Sins & Virtues. Skills, passives, and abilities are tied to the seven pairs; each axis is a spectrum from **-1** (sin) to **0** (neutral) to **+1** (virtue). **Implementation deferred; design only.**

**See also:** [PLANETOID_DESIGN.md](../../../VisionBoard/PLANETOID_DESIGN.md) (sin-themed levels), [VISION.md](../../../VisionBoard/Core/VISION.md) § Moral system.
