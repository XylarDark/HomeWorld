...
- **Host automation (MCP):** Prefer MCP `execute_python_script` for Editor scripts; see [docs/Automation/FULL_AUTOMATION_RESEARCH.md](docs/Automation/FULL_AUTOMATION_RESEARCH.md). Pre-swarm `run_automation_cycle.py` and agent-loop bats **removed WAVE F** — [Docs/08_AUDIT_SIGN_OFF.md](Docs/08_AUDIT_SIGN_OFF.md).
