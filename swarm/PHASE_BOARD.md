...
| PA-C-blender | PA-C | DESKTOP+Blender MCP | **OPEN / IN PROGRESS ready** | [32_PROTOTYPE_ASSETS.md](../Docs/32_PROTOTYPE_ASSETS.md) § PA-C queue | Unlocked by PA-A; cliffs → pines → cabin → path → planters → fence → glider perch → optional rim |
