...
2. Make your changes. If you touch setup or config, run through [docs/SETUP_VALIDATION.md](docs/SETUP_VALIDATION.md).
...
- **Week 1 tasks:** [docs/WEEK1_TASKS.md](docs/WEEK1_TASKS.md) – what to build first in the Editor.
- **Stack:** [docs/STACK_PLAN.md](docs/STACK_PLAN.md) – recommended tech per layer.

## Before opening a PR

- Run [docs/SETUP_VALIDATION.md](docs/SETUP_VALIDATION.md) if your change affects setup, plugins, or config.
